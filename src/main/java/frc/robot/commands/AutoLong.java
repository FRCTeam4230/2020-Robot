 ...
 */
public class AutoLong extends CommandBase {
  private final DriveTrain driveTrain;
  private final double autoSpeed = -0.6;
   ...
   */
  public AutoLong(DriveTrain _driveTrain) {
  ...
  public boolean isFinished() {
    if(Timer.getFPGATimestamp() > 4.0 + startTime) {
